...
class Styles {
  ...
  //display
  static final display_large = GoogleFonts.poppins(
    fontSize: 57,
    fontWeight: FontWeight.w400
  );
  static final display_medium = GoogleFonts.poppins(
    fontSize: 45,
    fontWeight: FontWeight.w400
  );
  static final display_small = GoogleFonts.poppins(
    fontSize: 36,
    fontWeight: FontWeight.w400
  );

  //headline
  static final headline_large = GoogleFonts.poppins(
    fontSize: 32,
    fontWeight: FontWeight.w400
  );
  static final headline_medium = GoogleFonts.poppins(
    fontSize: 28,
    fontWeight: FontWeight.w400
  );
  static final headline_small = GoogleFonts.poppins(
    fontSize: 24,
    fontWeight: FontWeight.w400
  );

  //title
  static final title_large = GoogleFonts.poppins(
    fontSize: 22,
    fontWeight: FontWeight.w400
  );
  static final title_medium = GoogleFonts.poppins(
    fontSize: 16,
    fontWeight: FontWeight.w500
  );
  static final title_small = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.w500
  );

  //Label
  static final label_large = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.w500
  );
  static final label_medium = GoogleFonts.poppins(
    fontSize: 12,
    fontWeight: FontWeight.w500
  );
  static final label_small = GoogleFonts.poppins(
    fontSize: 11,
    fontWeight: FontWeight.w500
  );

  //Body
  static final body_large = GoogleFonts.poppins(
    fontSize: 16,
    fontWeight: FontWeight.w400
  );
  static final body_medium = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.w400
  );
  static final body_small = GoogleFonts.poppins(
    fontSize: 12,
    fontWeight: FontWeight.w400
  );
